...
> If the player does not load, [download the clip](../assets/demo/tidewatch-dashboard-demo.mp4)
> (≈ 60 s).

<table>
<tr>
<td width="33%"><img src="../assets/demo/tidewatch-dashboard-screenshot-1.png" alt="All gauges normal"></td>
<td width="33%"><img src="../assets/demo/tidewatch-dashboard-screenshot-2.png" alt="CUX entering severe at the surge peak"></td>
<td width="33%"><img src="../assets/demo/tidewatch-dashboard-screenshot-3.png" alt="CUX sustained severe with the peak marker near the top band"></td>
</tr>
<tr>
...
Real data — see **M7** in [`docs/ISSUES.md`](../ISSUES.md): a PEGELONLINE source
